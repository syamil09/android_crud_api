...
//        btnSave.setOnClickListener(this::onClick);
    ...
    private void readDataku() {
        PerformNetworkRequest request = new PerformNetworkRequest(Api.READ_URL, null, CODE_GET_REQUEST);
        request.execute();
    }
    ...
    private void buatData() {
        ...
        PerformNetworkRequest request = new PerformNetworkRequest(Api.ADD_URL, params, CODE_POST_REQUEST);
        request.execute();
        closeKeyboard();
    }
    ...
    private void deleteData(int id) {
        ...
        PerformNetworkRequest request = new PerformNetworkRequest(Api.DELETE_URL + "&id=" + id, null, CODE_GET_REQUEST);
        request.execute();
    }
    ...
    public class PerformNetworkRequest extends AsyncTask<Void, Void, String> {
        ...
        List<Biodata> dataList = new ArrayList<Biodata>();
...
//                    Toast.makeText(MainActivity.this, "Sukses", Toast.LENGTH_SHORT).show();
    ...
    class DatakuAdapter extends ArrayAdapter<Biodata> {
        ...
        public DatakuAdapter(List<Biodata> dataList) {
            super(MainActivity.this, R.layout.layout_data_list, dataList );
